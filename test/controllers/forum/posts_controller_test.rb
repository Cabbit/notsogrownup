...
class Forum::PostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum_post" do
    assert_difference('Forum::Post.count') do
      post forum_posts_url, params: { forum_post: { body: @forum_post.body, title: @forum_post.title } }
    end
  ...
  test "should update forum_post" do
    patch forum_post_url(@forum_post), params: { forum_post: { body: @forum_post.body, title: @forum_post.title } }
